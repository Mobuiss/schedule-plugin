...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*MyScoreArgs)(nil), (*config.MyScoreArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta3_MyScoreArgs_To_config_MyScoreArgs(a.(*MyScoreArgs), b.(*config.MyScoreArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.MyScoreArgs)(nil), (*MyScoreArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_MyScoreArgs_To_v1beta3_MyScoreArgs(a.(*config.MyScoreArgs), b.(*MyScoreArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta3_MyScoreArgs_To_config_MyScoreArgs(in *MyScoreArgs, out *config.MyScoreArgs, s conversion.Scope) error {
	if err := v1.Convert_Pointer_string_To_string(&in.Address, &out.Address, s); err != nil {
		return err
	}
	if err := v1.Convert_Pointer_int64_To_int64(&in.TimeInSecond, &out.TimeInSecond, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1beta3_MyScoreArgs_To_config_MyScoreArgs is an autogenerated conversion function.
func Convert_v1beta3_MyScoreArgs_To_config_MyScoreArgs(in *MyScoreArgs, out *config.MyScoreArgs, s conversion.Scope) error {
	return autoConvert_v1beta3_MyScoreArgs_To_config_MyScoreArgs(in, out, s)
}

func autoConvert_config_MyScoreArgs_To_v1beta3_MyScoreArgs(in *config.MyScoreArgs, out *MyScoreArgs, s conversion.Scope) error {
	if err := v1.Convert_string_To_Pointer_string(&in.Address, &out.Address, s); err != nil {
		return err
	}
	if err := v1.Convert_int64_To_Pointer_int64(&in.TimeInSecond, &out.TimeInSecond, s); err != nil {
		return err
	}
	return nil
}

// Convert_config_MyScoreArgs_To_v1beta3_MyScoreArgs is an autogenerated conversion function.
func Convert_config_MyScoreArgs_To_v1beta3_MyScoreArgs(in *config.MyScoreArgs, out *MyScoreArgs, s conversion.Scope) error {
	return autoConvert_config_MyScoreArgs_To_v1beta3_MyScoreArgs(in, out, s)
}
