...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MyScoreArgs) DeepCopyInto(out *MyScoreArgs) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	if in.Address != nil {
		in, out := &in.Address, &out.Address
	...
	if in.TimeInSecond != nil {
		in, out := &in.TimeInSecond, &out.TimeInSecond
		*out = new(int64)
		**out = **in
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MyScoreArgs.
func (in *MyScoreArgs) DeepCopy() *MyScoreArgs {
	if in == nil {
		return nil
	}
	out := new(MyScoreArgs)
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *MyScoreArgs) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
